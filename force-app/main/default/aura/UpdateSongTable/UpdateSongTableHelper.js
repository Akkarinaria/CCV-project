({
  ...
  //      action.setParams({ searchGenre : genre });
        ...
        var mixId = component.get("v.mixIdFromEvent");
        ...
        action.setCallback(this, function(response) {
           ...
           //         component.set("v.selectedLength", 0);
                    ...
                    var prevSelectedSongsList = new Array();
                    ...
                    for (var i = 0; i < listOfAllSongs.length; i++)
                    {
                        ...
                        {
                            songsCount++;
                            prevSelectedSongsList.push(listOfAllSongs[i].objSong);
                            songsLength = songsLength + listOfAllSongs[i].objSong.Length_m__c;
                        }
                    }
                    
                    component.set("v.selectedCount", songsCount);
                    component.set("v.prevSelectedSongsList", prevSelectedSongsList);
